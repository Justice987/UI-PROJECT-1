...
import { SafeAreaView, StyleSheet, Text, View, TextInput, TouchableOpacity, Pressable } from 'react-native';
            ...
            <ScrollView>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.heading}>
                        ...
                        <Text style={styles.leading}>Create an accont✨</Text>
                    ...
                    <View style={styles.form}>
                        ...
                        <View style={styles.control}>
                            ...
                            <Icon name="person" size={24} color="#8c959f" style={styles.iconLeft} />
                            <TextInput
                    ...
                    <View style={styles.days}>
                        ...
                        <Text style={{ color: "gray", paddingLeft: 10 }}>Must be at least 8 characters</Text>
                    </View>
